<%@ Page Title="Edit User" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditYhxx.aspx.cs" Inherits="zxksglxtWeb.EditYhxx" %>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" runat="server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:TextBox ID="phone" runat="server" required="required" CssClass="form-control" placeholder="Please enter the email addres"></asp:TextBox>
                        </div>
