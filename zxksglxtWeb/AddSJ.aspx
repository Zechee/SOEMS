<%@ Page Title="Add Exam Paper" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddSJ.aspx.cs" Inherits="zxksglxtWeb.AddSJ" %>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" runat="server">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:TextBox ID="name" runat="server" required="required" CssClass="form-control" placeholder="Please enter a code"></asp:TextBox>
                        </div>
