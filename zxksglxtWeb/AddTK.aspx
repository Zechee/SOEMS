<%@ Page Title="Add Question Bank" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddTK.aspx.cs" Inherits="zxksglxtWeb.AddTK" %>
<asp:Content ID="Content1" ContentPlaceHolderID="style" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="breadcrumb" runat="server">
    <li>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/TKList.aspx"> Question Bank List</asp:HyperLink>
    </li>
</asp:Content>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                ErrorMessage="Content for Option A cannot be empty"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                ErrorMessage="Content for Option B cannot be empty"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                                ErrorMessage=" Content for Option C cannot be empty"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                                ErrorMessage="Content for Option D cannot be empty"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ErrorMessage="ontent for Option A cannot be empty"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                ErrorMessage="ontent for Option B cannot be empty"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                ErrorMessage="ontent for Option C cannot be empty"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                ErrorMessage="ontent for Option D cannot be empty"
