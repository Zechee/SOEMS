<%@ Page Title=" Edit Information" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="zxksglxtWeb.Profile" %>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" runat="server">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:TextBox ID="code" runat="server" required="required" CssClass="form-control" placeholder="Please enter the username"></asp:TextBox>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:TextBox ID="pwd" runat="server" type="password" required="required" CssClass="form-control" placeholder=" Please enter the password"></asp:TextBox>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:DropDownList ID="role" runat="server" CssClass="form-control" required="required" Enabled="false">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:TextBox ID="name" runat="server" required="required" CssClass="form-control" placeholder="Please enter the name"></asp:TextBox>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:DropDownList ID="sex" runat="server" CssClass="form-control" required="required">
                                <asp:ListItem Value="">--Please select the gender--</asp:ListItem>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:TextBox ID="phone" runat="server" required="required" CssClass="form-control" placeholder=" Please enter the email address"></asp:TextBox>
                        </div>
